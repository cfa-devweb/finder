        ...
        <div class="col-12 d-flex p-3">
            ...
            <div class="col-4">
                <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                    data-bs-target="#exampleModal2" data-bs-whatever="@fat">Ajouter une formation</button>
                <div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModal2Label"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-uppercase" id="exampleModal2Label">formulaire ajout d'une
                                    formation</h5>
                            ...
                            <div class="modal-body">
                                <form action="{{ route('dashboard-post')}}" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" aria-label="Default select example" id="adviser_id"
                                            name="adviser_id" required>
